...
[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/mice.pcr.sim)](https://cran.r-project.org/package=mice.pcr.sim)
...
The [`mice.pcr.sim`](https://cran.r-project.org/package=mice.pcr.sim) package
...
See [MICE: Multivariate Imputation by Chained Equations](https://amices.github.io/mice.pcr.sim/) 
for more resources.
...
1. [Handling Missing Data in `R` with `mice.pcr.sim`](https://amices.github.io/Winnipeg/)
...
6. [Sensitivity analysis with `mice.pcr.sim`](https://gerkovink.github.io/miceVignettes/Sensitivity_analysis/Sensitivity_analysis.html)
...
Please note that the mice.pcr.sim project is released with a [Contributor Code of Conduct](https://amices.github.io/mice.pcr.sim/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
