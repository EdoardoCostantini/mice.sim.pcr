...
#'
#' @aliases mice.pcr.sim.impute.norm.nob norm.nob
...
#' as implemented in \code{mice.pcr.sim.impute.norm} and improper (this function)
...
#' \code{mice.pcr.sim.impute.norm.nob}.
...
#' @seealso \code{\link{mice.pcr.sim}}, \code{\link{mice.pcr.sim.impute.norm}}
...
#' @keywords datagen
#' @export
mice.pcr.sim.impute.norm.nob <- function(y, ry, x, wy = NULL, ...) {
  if (is.null(wy)) wy <- !ry
