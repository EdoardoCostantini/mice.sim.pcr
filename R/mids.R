...
#' generated by functions \code{mice.pcr.sim()}, \code{mice.pcr.sim.mids()}, \code{cbind.mids()},
...
#'    \item{\code{blots}:}{"Block dots". The \code{blots} argument to the \code{mice.pcr.sim()}
#'    function.}
#'    \item{\code{ignore}:}{A logical vector of length \code{nrow(data)} indicating
#'    the rows in \code{data} used to build the imputation model. (new in \code{mice.pcr.sim 3.12.0})}
...
#'    \item{\code{version}:}{Version number of \code{mice.pcr.sim} package that
#'    created the object.}
...
#' }
#'
#' @note The \code{mice.pcr.sim} package does not use
...
#' @seealso \code{\link{mice.pcr.sim}}, \code{\link[=mira-class]{mira}},
#' \code{\link{mipo}}
